...
| Durable assignment excludes spool-blocked workers, reports all-blocked shortfall, and places a modeled 1,000 target plus 30% headroom after one of ten workers is unavailable | P0 | implemented scheduler invariant only | `python3 -m unittest tests.test_gui` |
