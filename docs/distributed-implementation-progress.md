...
| Worker resource benchmark | Hashed exported-state scenario drives real monitor probes and reports cycle/CPU percentiles, outcomes, peak RSS, and descriptors | Implemented and unit-tested; representative scenario, saturation curve, and fleet evidence missing |
