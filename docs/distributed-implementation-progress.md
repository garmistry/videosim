...
| Pressure-aware stable placement | Durable scheduler gives spool-blocked workers no assignments, retains schedulable fresh owners within capacity during incomplete recovery, reports unmet demand, and limits modeled loss to unavailable ownership | Implemented with modeled coverage plus a clean local 33-container/PostgreSQL hard-loss rerun: 440 failed owners moved, all 880 survivor owner/incarnation/epoch tuples stayed, and recovery completed in 65.565 seconds; repeated loss, live partition, separate-host timing, and media/headroom certification remain open |
