...
| DASH endpoint fixture matrix | Existing generator plus HTTP fault service provides healthy, 30-second slow, `503` dead, and malformed MPD endpoints with exported benchmark state | Implemented and Linux-smoke-tested; SRT matrix and long-run evidence missing |
