...
| Mixed fixture scenario | Seeded exact allocation composes 500 SRT/500 DASH and 800/100/50/50 healthy/slow/dead/malformed logical streams from hashed fixture states | Implemented and one-cycle Linux-tested; eight shared endpoints, not independent load or capacity evidence |
