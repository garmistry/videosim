...
| F5 — 1,000-stream admission | Production-like workload manifest and immutable evidence bundle | 24-hour run, 30% headroom after one failure-domain loss, all audit Section 13.3 criteria | Policy/verifier and 1,320-URL saturation input implemented; calibrated 22-survivor single-host run failed the 90-second gate on 14 workers, and multi-host failure/soak evidence remains absent |
