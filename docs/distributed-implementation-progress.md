...
| Pressure-aware stable placement | Durable scheduler gives spool-blocked workers no assignments, retains fresh owners up to balanced total/protocol targets, reports unmet demand, and limits modeled 1,300-item worker loss to the failed worker's 130 assignments | Implemented and PostgreSQL-path tested; no hysteresis, durable queue, partition/TTL evidence, or media/headroom certification |
